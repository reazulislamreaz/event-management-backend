...
export const CACHE_KEYS = {
  ...
  AUTH: {
    ...
    PASSWORD_RESET_SESSION: (resetToken: string) => `auth:password-reset:session:${resetToken}`,
    PASSWORD_RESET_TOKEN: (resetToken: string) => `auth:password-reset:token:${resetToken}`,
